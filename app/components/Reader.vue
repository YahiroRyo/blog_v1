<template>
  <div>
    <v-card flat v-html="mdFunc.render(md)" class="markdown"> </v-card>
    <Component is="style">
      ...
      break-word; } } .markdown { height: 175px; overflow-y: scroll; }
    </Component>
  </div>
</template>
...
export default {
  props: ["md"],
  data(this: { $md: Function }): any {
    return {
      mdFunc: this.$md as Function,
    };
  },
};
</script>
